...
DEFAULT_CONFIG: dict[str, Any] = {
    ...
    "daily_workflow": {
        "enabled": True,
        "control_first": True,
        "auto_vla_scheduler_enabled": True,
        "min_control_operations_before_vla": 6,
        "control_stall_minutes_before_vla": 30,
        "vla_trigger_poll_seconds": 10,
        "vla_retry_cooldown_minutes": 30,
        "allow_vla_when_control_stalled": True,
        "allow_vla_when_gold_rank_gt": 100,
        "gold_arm_label": "Training Arm Gold",
        "min_labels_per_day": 2,
        "max_labels_per_day": 200,
        "min_vla_tasks_per_day": 10,
        "max_vla_tasks_per_day": 10,
        "max_episodes_per_task": 20,
        "require_control_idle_before_vla": True,
    ...
    "safety": {
        ...
        "allow_auto_fail_submit": True,
        "force_submit_live_vla": True,
        "strict_fail_submit_min_confidence": 0.90,
        "strict_fail_submit_max_pass_probability": 0.10,
        "max_auto_submit_per_run": 200,
        "stop_on_first_submit_error": True,
        "submit_cooldown_seconds": 2,
        "require_extension_pause_for_vla": True,
    },
    "frame_sampling": {
